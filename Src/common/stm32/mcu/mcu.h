...
// DEV_ID values
typedef enum {
    // Category 2 - STM32G431, STM32G441 (AES)
    // RM0440 Rev 3 p.2087, p.73
    MCU_DEV_ID_STM32G431_441 = 0x468,
    // Category 3 - STM32G471, STM32G473, STM32G474, STM32G483, STM32G484
    // RM0440 Rev 3 p.2087, p.73
    MCU_DEV_ID_STM32G471_473_474_483_484 = 0x469,
    // Same DEV_ID for STM32H742, STM32H743/753, and STM32H750
    // RM0433 Rev 7 p.3189
